 ...
 * {@link getFragment.OnFragmentInteractionListener} interface
...
public class getFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        final TextView myText = (TextView) getView().findViewById(R.id.textGet);

        Button button = (Button) view.findViewById(R.id.button4);
        final EditText get_id = (EditText) getView().findViewById(R.id.get_id);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                RequestQueue queue = Volley.newRequestQueue(getContext());
                String url = "http://192.168.1.104:3000/player/"+get_id.getText();
